		...
		<div id="wrapper">
				...
				<nav class="navbar navbar-default navbar-static-top">
					<div class="navbar-header">
						<a style="padding-top: 7px;" class="navbar-brand">&nbsp;&nbsp;<span><img src="<?php echo base_url(); ?>assets/img/h2.png" width="5%">&nbsp;&nbsp;Penentuan Desa Tertinggal dengan Menggunakan Metode AHP</span></a>
					</div>
				</nav>
			<div class="navbar-default sidebar" role="navigation">
						<div class="sidebar-nav navbar-collapse">
							<ul id="side-menu" class="nav">
								<li class="active"><span class="glyphicon glyphicon-folder-open aria-hidden="true" style="margin-left: 20"></span>&nbsp;&nbsp;&nbsp;&nbsp;Deskripsi</li>
							</ul>
						</div>	
					</div>
