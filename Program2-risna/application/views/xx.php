	  				...
	  				<div class="panel-body">
						...
						<div class="tab-content">
						    <div id="topik" class="tab-pane fade in active" style="padding-top: 20px;">
						    	<div class="col-md-3">
									<span style="font-size: 1400%" class="glyphicon glyphicon-book aria-hidden="true"></span>
								</div>
						    ...
						    <div id="algoritma" class="tab-pane fade" style="padding-top: 20px;">
						    	<b>Analythical Hierarcy Process (AHP)</b><br>
						    	<div class="col-md-4">
						    ...
						    <div id="data" class="tab-pane fade" style="padding-top: 20px;">						    	
						    	<div class="row">
						    		<div class="col-md-12" style="overflow-x: scroll; width:1100px; ">
								      	<table class="table table-bordered" >
											...
											<tr>
												<td class="info">Tipe Mobil</td>		
												<?php foreach($alternatif as $alt){ ?>										
													<td class="info"><b><?php echo $alt['nama']; ?></b></td>											
												<?php } ?>
											</tr>
											<tr>
												<td>Deskripsi</td>		
						    		...
						    		<div class="col-md-12">
						    			...
						    			<div class="col-md-10">
							      			<table class="table">
								    			...
								    			<?php $i=0;foreach($rekomendasi as $key){?>
								    			    <tr>
								    			    	<td><?php echo $i+1; ?></td>
