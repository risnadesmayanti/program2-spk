						...
						<div class="tab-content">
						    <div id="topik" class="tab-pane fade in active" style="padding-top: 20px;">
								<div class="col-md-12 jumbotron">
									  ...
									  <p><a class="btn btn-primary btn-lg" href="<?php echo base_url(); ?>assets/Laporan.docx" role="button">Learn more</a></p>
								</div>
						    </div>
						    		...
						    		<div class="col-md-12">
						    			...
						    			<div class="col-md-10">
							      			<table class="table">
									    			...
									    			<?php $arr=array('success','danger','warning','info');$i=0;$f = $rekomendasi[0]['value'];foreach($rekomendasi as $key){?>
									    			    <tr>
									    			    	<td><?php echo $i+1; ?></td>
